...
const natural = require('natural'); //frm added

// Task 2: initialize the express server
const app = express(); //frm added 
...
app.post('/sentiment', async (req, res) => { //frm added

    // Task 4: extract the sentence parameter
    const { sentence } = req.query; //frm added 
    ...
    try {
       ...
       // Responding with the sentiment analysis result - frm added
        ...
        res.status(500).json({ message: 'Error performing sentiment analysis' }); //frm added
    }
});
